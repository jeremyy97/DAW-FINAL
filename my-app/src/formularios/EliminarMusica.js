...
import { deleteMusica } from '../utils/api';

class EliminarMusica extends Component{
    constructor(props){
        super(props);
        this.state={
            id : this.props.id
    ...
    render() {
        return (
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">¿Está seguro de eliminar la canción {this.props.nombre}?</div>
